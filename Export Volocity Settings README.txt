...
## Details
Exports all currently active settings for Volocity to a registry (.reg) file so they can be restored at a later point in time.
...
## Notes
- Transfer between different Volocity workstations is not recommended, as the hardware setup may not be the same and
  things might get screwed up as a consequence.
